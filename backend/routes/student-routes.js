...
router.get(
  "/get-all-course-assignments/:courseID",
  studentController.getAllCourseAssignments
);

router.get(
  "/get-course-assignment/:assignmentID",
  studentController.getCourseAssignmentByAssignmentD
);
...
router.get(
  "/download-course-material/:courseMaterialID",
  studentController.downloadCourseMaterial
);

router.get(
  "/download-course-assignment/:assignmentID",
  studentController.downloadAssignmentMaterial
);
