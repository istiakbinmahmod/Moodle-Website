...
router.post('/upload-material/:courseID', teacherController.uploadCourseMaterials); // => localhost:5000/teacher/create-material/:courseID to create a new material
...
router.post('/upload-course-assignment/:courseID', teacherController.uploadCourseAssignment); // => localhost:5000/teacher/create-assignment/:courseID to create a new assignment
